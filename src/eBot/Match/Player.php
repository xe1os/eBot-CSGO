...
class Player {
    ...
    public function snapshot($round) {
        ...
        \mysqli_query($this->mysqli_link, "INSERT INTO players_snapshot 
            ...
            VALUES
            ({$this->mysqli_id}, {$this->kill}, {$this->death}, {$this->assist}, {$this->point}, {$this->hs}, {$this->defuse}, {$this->bombe}, {$this->tk}, {$this->v1}, {$this->v2}, {$this->v3}, {$this->v4}, {$this->v5}, {$this->k1}, {$this->k2}, {$this->k3}, {$this->k4}, {$this->k5}, {$this->firstKill}, {$round}, {$this->damage_given}, {$this->damage_taken}, NOW(), NOW())") or Logger::error("Error while snapshoting");
    }
